...
begin:"{",end:"}",illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,n]}]}}}());hljs.registerLanguage("properties",function(){"use strict";return function(e){
...
relevance:0}],starts:r},{className:"attr",relevance:0,begin:s+n+"$"}]}}}());hljs.registerLanguage("xml",function(){"use strict";return function(e){var n={
...
},i,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,r,e.CSS_NUMBER_MODE]}]}}}());hljs.registerLanguage("javascript",function(){"use strict"
